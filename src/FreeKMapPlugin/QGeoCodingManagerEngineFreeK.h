...
///
/// \brief The QGeoCodingManagerEngineFreeK class
/// 地理编码管理引擎
class QGeoCodingManagerEngineFreeK : public QGeoCodingManagerEngine
{
    Q_OBJECT

public:
    QGeoCodingManagerEngineFreeK(const QVariantMap &parameters, QGeoServiceProvider::Error *error, QString *errorString);
    ~QGeoCodingManagerEngineFreeK();
