...
#include <QTimer>
///
/// \brief The QGeoTiledMapReplyFreeK class
///瓦片地图请求回复
class QGeoTiledMapReplyFreeK : public QGeoTiledMapReply
{
    Q_OBJECT
public:
    QGeoTiledMapReplyFreeK(QNetworkAccessManager*  networkManager, const QNetworkRequest& request, const QGeoTileSpec &spec, QObject *parent = 0);
    ~QGeoTiledMapReplyFreeK();
    void abort();
