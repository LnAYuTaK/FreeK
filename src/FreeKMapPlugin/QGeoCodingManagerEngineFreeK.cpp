...
#include "QGeoCodingManagerEngineFreeK.h"
#include "QGeoCodeReplyFreeK.h"
...
QGeoCodingManagerEngineFreeK::QGeoCodingManagerEngineFreeK(
...
QGeoCodeReply *QGeoCodingManagerEngineFreeK::geocode(const QGeoAddress &address, const QGeoShape &bounds)
{
    return geocode(addressToQuery(address), -1, -1, bounds);
}

QGeoCodeReply *QGeoCodingManagerEngineFreeK::geocode(const QString &address, int limit, int offset, const QGeoShape &bounds)
{
    Q_UNUSED(limit);
    Q_UNUSED(offset);
    ...
    QGeoCodeReplyFreeK *geocodeReply = new QGeoCodeReplyFreeK(reply);

    connect(geocodeReply, &QGeoCodeReply::finished, this, &QGeoCodingManagerEngineFreeK::replyFinished);
...
QGeoCodeReply *QGeoCodingManagerEngineFreeK::reverseGeocode(const QGeoCoordinate &coordinate, const QGeoShape &bounds)
{
    Q_UNUSED(bounds)
...
void QGeoCodingManagerEngineFreeK::replyFinished()
{
...
void QGeoCodingManagerEngineFreeK::replyError(QGeoCodeReply::Error errorCode, const QString &errorString)
{
    QGeoCodeReply *reply = qobject_cast<QGeoCodeReply *>(sender());
    if (reply)
