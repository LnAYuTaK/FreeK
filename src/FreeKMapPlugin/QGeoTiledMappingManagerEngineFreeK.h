...
///
/// \brief The QGeoTiledMapFreeK class
///创建Map地图
///
class QGeoTiledMapFreeK : public QGeoTiledMap
{
    Q_OBJECT
public:
    QGeoTiledMapFreeK(QGeoTiledMappingManagerEngine *engine, QObject *parent = 0);
};

class QGeoTileFetcherFreeK;

///瓦片地图引擎
class QGeoTiledMappingManagerEngineFreeK : public QGeoTiledMappingManagerEngine
{
    Q_OBJECT
public:
